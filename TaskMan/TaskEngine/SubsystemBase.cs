...
{
    /// <summary>
    /// Базовый класс подсистем Движка.
    /// </summary>
    /// <remarks>
    ...
    /// 3. Open() не принимает параметры от вызывающего кода. Это недостаток, придется передавать их через проперти, это неудобно, не наглядно.
    ///    Close() не нужно передавать параметры, тут все хорошо.
    /// </remarks>
    public class SubsystemBase
    {
        ...
        /// NT-Конструктор
        /// </summary>
        public SubsystemBase(CEngine engine)
        {
            this.m_Ready = false;
